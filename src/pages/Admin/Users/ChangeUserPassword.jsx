...
import { adminChangeUserPasswordOpreation } from "../../../actions/authActions";
...
function ChangeUserPassword() {
    ...
    const handleChangePasswordSubmit = (e) => {
        ...
        dispatch(adminChangeUserPasswordOpreation(formData, pk));
      };
      ...
      useEffect(() => {
        if (authState.passwordChangeResponse) {
          ...
          dispatch(displayMessage(authState.passwordChangeError, "bg-danger"));
        }
      }, [authState]);
  ...
  >
    <section className="mx-3">
      <PageHeader title={"Change User Password"} />
            ...
            <Card>
              <Card.Body>
                ...
                <Form onSubmit={handleChangePasswordSubmit}>
                  <div>
                    <div className="mb-3">
                      <h5 className="mb-1">Change User Password</h5>
                    </div>
                    ...
                    <Row>
                      <Col>
                        <Button className="w-100" type="submit">
                          {authState.passwordChangeLoading ? (
                            <Spinner
                              animation="border"
                              size="sm"
                              role="status"
