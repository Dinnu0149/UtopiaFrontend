...
import { getRevenues, deleteRevenue } from "../../../actions/revenueActions";
...
function RevenueList() {
  ...
  useEffect(() => {
    dispatch(getRevenues(currentPage));
          ...
          <Col md={12} xs={12}>
            <Card className="border-0 shadow-lg">
              ...
              {filteredData && filteredData.length > 0 ? (
                    ...
                    {filteredData.map((revenue, index) => {
                      return (
                        <tr key={revenue.pk}>
                          ...
                          <td className="">
                            <span
                              className={`badge py-2 text-capitalize ${
                                revenue.status === "ready"
                                  ? "bg-primary"
                                  : revenue.status === "inProcess"
                                  ? "bg-warning"
                                  : "bg-success"
                              }`}
                            >
                ...
                <NonAvailable message="Sorry no event revenue avaliable" />
              )}
